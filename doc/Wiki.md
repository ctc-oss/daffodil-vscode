...
To generate a compressed archive of the TDML test cases, you simply need to have the TDML file opened (and in the active tab) in either the TDML editor or a text editor. Then you open the command pallet and find the "Zip TDML file" command and execute it.
...
* Users may encounter issues with path formatting in the TDML file if zip files are moved between Windows & Linux OSs.
