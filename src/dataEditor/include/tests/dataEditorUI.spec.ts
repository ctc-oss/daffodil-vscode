...
import { MockEditorMediator, MockEvent, MockMediator } from './utils/mocks'
import assert from 'assert'

class ConsoleEditorUI extends DataEditorUI<MockEvent> {
  ...
  constructor() {
    super(MockMediator, 'consoleui')
  }
  protected registerEventHandlers(): void {
    this.mediator.register('strEvent', (strEvent) => {
      this.uiText = strEvent.str
    })
  }
}
